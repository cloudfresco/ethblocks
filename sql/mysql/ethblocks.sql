...
CREATE TABLE `block_uncles` (
  ...
  `block_nonce` bigint(20) DEFAULT NULL,
...
CREATE TABLE `transaction_receipts` (
  ...
  `tx_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tx_index` int(10) unsigned DEFAULT NULL,
  `tx_status` bigint(20) DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `block_number` bigint(20) DEFAULT NULL,
  `block_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_nonce` bigint(20) DEFAULT NULL,
  `price` bigint(20) DEFAULT NULL,
  `gas_limit` bigint(20) DEFAULT NULL,
  `tx_amount` bigint(20) DEFAULT NULL,
  `payload` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tx_v` bigint(20) DEFAULT NULL,
  `tx_r` bigint(20) DEFAULT NULL,
  `tx_s` bigint(20) DEFAULT NULL,
  `block_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
